...
public class HighProbabilityCharmLoot extends LootTableAdderLoot {
    ...
    private static Collection<Tuple<Double, Supplier<ItemStack>>> createItems() {
        return List.of(new Tuple[]{
                new Tuple<>(0.8, (Supplier<ItemStack>)() -> CharmFactory.createBook(CharmModelData.CHARM_III)),
                new Tuple<>(0.9, (Supplier<ItemStack>)() -> CharmFactory.createBook(CharmModelData.CHARM_II)),
                new Tuple<>(1.0, (Supplier<ItemStack>)() -> CharmFactory.createBook(CharmModelData.CHARM_I))
        });
    }
}
