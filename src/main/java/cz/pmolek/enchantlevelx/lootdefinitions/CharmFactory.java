...
public final class CharmFactory {
  ...
  /**
   * Creates a book item with custom properties based on the given CharmModelData.
   *
   * @param  data  the CharmModelData object containing the data for creating the book.
   * @return       the created ItemStack representing the book item.
   */
  public static ItemStack createBook(CharmModelData data) {
    ...
    switch (data.level) {
      case 1:
        ...
        lore.add(
            ChatColor.GRAY + "Combine with a " + ChatColor.WHITE + "max-level" + ChatColor.GRAY
                + " Enchanted Book.");
        break;
      case 2:
        meta.setDisplayName(data.color + "Charm of Enchanting II");
        lore.add(ChatColor.GRAY + "Combine with an Enchanted Book charmed by " + ChatColor.YELLOW
            + "Charm I" + ChatColor.GRAY + ".");
        break;
      case 3:
        meta.setDisplayName(data.color + "Charm of Enchanting III");
        lore.add(ChatColor.GRAY + "Combine with an Enchanted Book charmed by " + ChatColor.AQUA
            + "Charm II" + ChatColor.GRAY + ".");
        break;
      default:
    ...
    // 112000 is the "prefix" for this plugin, 1 is item ID for Charm of Enchanting,
    // then level is added
