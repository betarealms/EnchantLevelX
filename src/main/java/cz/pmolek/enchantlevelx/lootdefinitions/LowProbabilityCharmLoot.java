...
public class LowProbabilityCharmLoot extends LootTableAdderLoot {
    ...
    private static List<Tuple<Double, Supplier<ItemStack>>> createItems() {
        return List.of(new Tuple[]{
                new Tuple<>(0.13, (Supplier<ItemStack>)() -> CharmFactory.createBook(CharmModelData.CHARM_III)),
                new Tuple<>(0.36, (Supplier<ItemStack>)() -> CharmFactory.createBook(CharmModelData.CHARM_II)),
                new Tuple<>(0.55, (Supplier<ItemStack>)() -> CharmFactory.createBook(CharmModelData.CHARM_I))
        });
    }
}
