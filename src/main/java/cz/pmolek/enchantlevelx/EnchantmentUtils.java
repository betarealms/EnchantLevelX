...
public final class EnchantmentUtils {
    ...
    public static List<Tuple<Enchantment, Integer>> getEnchantmentsThat(ItemStack item, BiPredicate<Enchantment, Integer> predicate) {
        ...
        for (Map.Entry<Enchantment, Integer> enchantment : getEnchantmentsUnsafe(item).entrySet()) {
            ...
            if (predicate.test(tuple.getA(), tuple.getB()))
                result.add(tuple);
        }
        return result;
    }
